...
export const Contact = () => {
  ...
  let param;
  if (params.frm) param = params.frm;
  else param = "generalInfo";
      ...
      <div className="contact max-container">
        ...
        <div className="form-wrapper">
          <div className="contact-options-wrapper">
            <div
              className={
                activeClasses.generalInfo
                  ? "contact-option-card selected"
                  : "contact-option-card"
              }
              onClick={() => toggleClass("generalInfo")}
            >
              <div className="contact-option-img">
                <img
                  src={AllImages.GeneralInfo}
                  alt={contactData.option4["alt.img"]}
                />
              </div>
              <div className="contact-option-title">
                <label>
                  {size.width <= 1024
                    ? contactData.option4.titlesm
                    : contactData.option4.title}
                </label>
              </div>
            </div>
            ...
            <div
              className={
                activeClasses.aNewApp
                  ? "contact-option-card selected"
                  : "contact-option-card"
              }
              onClick={() => toggleClass("aNewApp")}
            >
              <div className="contact-option-img">
                <img
                  src={AllImages.ANewApp}
                  alt={contactData.option2["alt.img"]}
                />
              </div>
              <div className="contact-option-title">
                <label>
            ...
            <div
              className={
                activeClasses.redesign
                  ? "contact-option-card selected"
                  : "contact-option-card"
              }
              onClick={() => toggleClass("redesign")}
            >
              <div className="contact-option-img">
                <img
                  src={AllImages.Redesign}
                  alt={contactData.option3["alt.img"]}
                />
              </div>
              <div className="contact-option-title">
                <label>
            ...
            <div
              className={
                activeClasses.staffAugmentation
                  ? "contact-option-card selected"
                  : "contact-option-card"
              }
              onClick={() => toggleClass("staffAugmentation")}
            >
              <div className="contact-option-img">
                <img
                  src={AllImages.StaffAugmentation}
                  alt={contactData.option5["alt.img"]}
                />
              </div>
              <div className="contact-option-title">
                <label>
          ...
          <div
            className={
              activeClasses.generalInfo
                ? "contact-form border-radius-left"
                : activeClasses.staffAugmentation
                ? "contact-form border-radius-right"
                : "contact-form"
            }
          >
            {activeClasses.aNewLanding && (
              <FrmNewApp submitFunction={submitFunction} />
            )}
            {activeClasses.aNewApp && (
              <FrmNewApp submitFunction={submitFunction} />
            )}
            {activeClasses.redesign && (
              <FrmReRe submitFunction={submitFunction} />
            )}
            {activeClasses.generalInfo && (
              <FrmGeneralInfo submitFunction={submitFunction} />
            )}
            {activeClasses.staffAugmentation && (
              <FrmStaffAugmentation submitFunction={submitFunction} />
            )}
          </div>
        </div>
        {modal && (
